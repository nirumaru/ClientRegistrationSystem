...
namespace ClientRegistrationApp
{
    public partial class ClientRegistrationSystem : Form
    {
        ...
        {
            var val = int.Parse(txtboxClientId.Text).ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"All client details saved successfully to {filePath}.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
